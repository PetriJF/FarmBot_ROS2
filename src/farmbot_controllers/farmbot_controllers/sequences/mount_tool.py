...
def mount_tool(x: float = 0.0, y: float = 0, z: float = 0.0,
    ...
    """
    Build a sequence to mount a tool at a specified gantry location.

    Args:
        x (float): X coordinate of the tool mounting location.
        y (float): Y coordinate of the tool mounting location.
        z (float): Z coordinate of the tool mounting position.
